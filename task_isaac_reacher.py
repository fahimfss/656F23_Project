...
from relod.envs.isaac_reacher_env.reacher_env import CarterReacherEnv
...
def parse_args():
    ...
    # environment
    parser.add_argument('--target_type', default='isaac_reacher_pei', type=str)
    parser.add_argument('--image_height', default=90, type=int)
    parser.add_argument('--image_width', default=160, type=int)
    parser.add_argument('--stack_frames', default=3, type=int)
    parser.add_argument('--episode_steps', default=500, type=int)
    # replay buffer
...
def main(seed=-1, env=None):
    ...
    args.work_dir += f'/results/{args.target_type}/seed_{args.seed}' 
    ...
    # hf_paths = ["/home/isaac/.local/share/ov/pkg/isaac_sim-2023.1.0-hotfix.1/reacher_st/hf/hf_fahim",
    # "/home/isaac/.local/share/ov/pkg/isaac_sim-2023.1.0-hotfix.1/reacher_st/hf/hf_joyce",
    # "/home/isaac/.local/share/ov/pkg/isaac_sim-2023.1.0-hotfix.1/reacher_st/hf/hf_pei"]
    # hf_paths = None

    hf_paths = ["/home/isaac/.local/share/ov/pkg/isaac_sim-2023.1.0-hotfix.1/reacher_st/hf/hf_pei"]

    args.hf_paths = hf_paths
    ...
    for step in range(args.env_steps):
        ...
        if done or (episode_step == args.episode_steps): # set time out here
...
if __name__ == '__main__':
    env = CarterReacherEnv(scene_path="/home/isaac/.local/share/ov/pkg/isaac_sim-2023.1.0-hotfix.1/reacher_st/relod/relod/envs/isaac_reacher_env/arena2.usd",
                           seed=0,
                           image_width=160,
                           image_height=90,
                           img_type='chw',
